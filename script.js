document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value.trim() !== '') {
        if ((fieldType === 'email' || field.dataset.validate === 'email') && !VALIDATORS.email(value)) {
          showError(field, getErrorMessage(field, 'email'));
          return false;
        }

        if ((fieldType === 'tel' || field.dataset.validate === 'tel') && !VALIDATORS.tel(value)) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '06f446de-46dd-4d23-9540-4b508162f3b4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '06f446de-46dd-4d23-9540-4b508162f3b4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '06f446de-46dd-4d23-9540-4b508162f3b4';
